...
public class ProductDAOImpl implements ProductDAO{
   ...
   private void createTable() {
    try {
    	String sqlCreate = "CREATE TABLE IF NOT EXISTS product  ( code  varchar(45) , name  varchar(45) , price  double precision , gst double precision)";
    ...
    public List<Product> getNameLike(String name) {
    	  ...
    	  String sql = "SELECT * FROM product WHERE LOWER(name) LIKE '%"+name+"%'";
    	   List<Product> listProduct = jdbcTemplate.query(sql, new RowMapper<Product>() {
